...
SETTINGS_DB: Final[dict] = {
    ...
    "Textures": {
        ...
        "lod_bias": {
            "section": "textures",
            "label": "Viés LOD",
            "description": "Desloca a seleção de mipmap. Negativo nitida ao custo de cintilação, positivo borra mas renderiza mais rápido. Um viés negativo é o mais próximo que o volt chega de nitidez. A lista vai em passos de 0.2 no intervalo que sua GPU reporta, até 4 para cada lado.",
            "options": (DEFAULT_VALUE,),
        },
        "mip_floor": {
            "section": "textures",
