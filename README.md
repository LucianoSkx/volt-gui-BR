...
**Deslocamento do Limite** desloca o limite em -20 a 20 em passos de dois. Telas VRR querem o limite logo abaixo da atualização: escolha 144, defina -6, caia em 138. O volt nunca desloca um limite sozinho já que a maioria das telas não é VRR.
...
As cinco configurações de Taxa de Quadros não têm valor pedido, já que um jogo nunca diz ao Vulkan qual taxa quer. Elas reportam o que o volt aplicou, ou dizem que o perfil não as definiu.
